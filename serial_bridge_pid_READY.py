...
Subscribes to /cmd_vel, converts to wheel velocity targets, sends to Arduino PID.
...
class SerialBridge(Node):
    ...
    def cmd_vel_callback(self, msg):
        ...
        # Convert to ticks/sec for Arduino PID
        left_tps = left_vel * self.ticks_per_m
        right_tps = right_vel * self.ticks_per_m

        self.send_velocity_command(left_tps, right_tps)

    def send_velocity_command(self, left_tps, right_tps):
